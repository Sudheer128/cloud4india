...
const OurApproachSection = () => {
  const approaches = [
    {
      icon: (
        <svg className="w-16 h-16 text-saree-teal" fill="currentColor" viewBox="0 0 20 20">
      ...
      description: 'Optimized for speed, security, and resilience'
    },
    {
      icon: (
        <svg className="w-16 h-16 text-saree-lime" fill="currentColor" viewBox="0 0 20 20">
          <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z" clipRule="evenodd" />
        </svg>
      ),
      title: '99.99% UPTIME',
      description: 'Ensuring uninterrupted business operations'
    },
    {
      icon: (
        <svg className="w-16 h-16 text-saree-amber" fill="currentColor" viewBox="0 0 20 20">
          <path d="M11 3a1 1 0 10-2 0v1a1 1 0 102 0V3zM15.657 5.757a1 1 0 00-1.414-1.414l-.707.707a1 1 0 001.414 1.414l.707-.707zM18 10a1 1 0 01-1 1h-1a1 1 0 110-2h1a1 1 0 011 1zM5.05 6.464A1 1 0 106.464 5.05l-.707-.707a1 1 0 00-1.414 1.414l.707.707zM5 10a1 1 0 01-1 1H3a1 1 0 110-2h1a1 1 0 011 1zM8 16v-1h4v1a2 2 0 11-4 0zM12 14c.015-.34.208-.646.477-.859a4 4 0 10-4.954 0c.27.213.462.519.476.859h4.002z" />
        </svg>
      ),
      title: 'HYPERCONVERGED INFRASTRUCTURE',
      description: 'Seamless integration and resource optimization'
    },
    {
      icon: (
        <svg className="w-16 h-16 text-saree-teal" fill="currentColor" viewBox="0 0 20 20">
      ...
      title: '24/7 SUPPORT',
      description: 'Dedicated experts, always ready to assist'
    }
  ]
