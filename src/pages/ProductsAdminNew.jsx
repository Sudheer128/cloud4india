...
import ProductBasicInfo from '../components/ProductEditor/ProductBasicInfo';
import SectionManager from '../components/ProductEditor/SectionManager';
import ItemManager from '../components/ProductEditor/ItemManager';

const ProductsAdminNew = () => {
  ...
  const loadData = async () => {
    try {
      ...
      if (productsRes.ok) {
        ...
        // Load specific product if not new
        if (productId !== 'new') {
  ...
  const handleSaveBasicInfo = async (formData) => {
    ...
    try {
      ...
      // Ensure route has /products/ prefix
      const routeWithPrefix = formData.route.startsWith('/products/')
        ? formData.route
        : `/products/${formData.route}`;
      ...
      const payload = {
        ...
        enable_single_page: 1 // Always enabled for products
      };
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">
                  {productId === 'new' ? 'New Product' : product?.name || 'Edit Product'}
                </h1>
          ...
          <div className="flex gap-1 mt-4">
            <TabButton
              ...
              status={product && product.name ? 'complete' : 'pending'}
            />
            <TabButton
...
export default ProductsAdminNew;
