            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-gray-600 mb-8">
                  Reach out to us through any of these channels. We're here to help you with your cloud infrastructure needs.
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {!phoneVerified && (
                  <p className="text-sm text-red-600 text-center mt-2">
                    Phone verification is required to submit the form
                  </p>
                )}
              </form>
            </div>
            ...
            <div className="h-96 bg-gray-200 flex items-center justify-center">
              ...
              <div className="text-center p-8">
                ...
                <p className="text-gray-500 text-sm">
                  3052 "Prestige Finsbury Park Hyde"<br />
                  Aerospace Park, Bagalur KIADB<br />
                  Bengaluru, 562149, India
                </p>
                <p className="text-gray-400 text-xs mt-4">
                  {/* Add Google Maps embed code here */}
                  <a 
                    href="https://www.google.com/maps/search/?api=1&query=Bagalur+KIADB+Bengaluru" 
                    target="_blank" 
                    rel="noopener noreferrer"
