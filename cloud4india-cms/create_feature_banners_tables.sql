...
INSERT OR IGNORE INTO feature_banners (id, category, title, subtitle, cta_text, cta_link, gradient_start, gradient_mid, gradient_end, accent_gradient_start, accent_gradient_end, order_index) VALUES
    (1, 'Event', 'Join us at Cloud4India Summit 2025—India''s largest cloud infrastructure event', 'Connect with industry leaders and explore the future of cloud computing', 'Register Now', '#', 'aws-navy', 'aws-blue', 'phulkari-turquoise-dark', 'aws-blue', 'phulkari-turquoise', 1),
