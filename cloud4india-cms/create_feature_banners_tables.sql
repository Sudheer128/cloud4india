...
INSERT OR IGNORE INTO feature_banners (id, category, title, subtitle, cta_text, cta_link, gradient_start, gradient_mid, gradient_end, accent_gradient_start, accent_gradient_end, order_index) VALUES
    ...
    (2, 'Innovation', 'Accelerate your digital transformation with AI-powered cloud solutions', 'Discover how leading enterprises are scaling with Cloud4India''s intelligent infrastructure', 'Learn More', '#', 'saree-teal', 'phulkari-turquoise', 'saree-lime', 'saree-teal', 'phulkari-turquoise', 2),
